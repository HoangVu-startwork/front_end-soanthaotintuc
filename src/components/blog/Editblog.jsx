...
import { EditOutlined, SearchOutlined, DeleteOutlined, PlusOutlined, DownloadOutlined, FileTextOutlined } from '@ant-design/icons';
                ...
                return (
                  <List.Item key={item.urlBlog}>
                    <Card cover={
                      ...
                      actions={[
                        <Link to={`${item.urlBlog}`}><FileTextOutlined key="edit" /></Link>,
                      ]}
                    >
